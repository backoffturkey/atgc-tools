...
def Seqs_Cleaner(in_name, out_name, seq_type, trans_fr, gen_code, bin_mode, seqs_min_len, seqs_dissection, dummy_qual):
...
if __name__ == "__main__":
	...
	if len(sys.argv) <= 8 or len(sys.argv) > 9:
		print ""
		print "  Program usage: "
		print "  input_file  output_file  DNA/prot  trans_frame[0 1 3 6]  genetic_code[1 2 3]  BIN/NOBIN  seqs_min_len SEQS_SPLIT/SEQS"
	...
	if len(sys.argv) == 9:
		...
		if seqs_dissection != "SEQS_SPLIT" and seqs_dissection != "SEQS" and seqs_dissection != "QUAL" and seqs_dissection != "CAP3":
			print "  SEQS DISSECTION MUST BE \"SEQS_SPLIT\" OR \"SEQS\" OR \"QUAL\""
			sys.exit()
		dummy_qual = "18 "
		if in_name != out_name:
			Seqs_Cleaner(in_name, out_name, seq_type, trans_fr, gen_code, bin_mode, seqs_min_len, seqs_dissection, dummy_qual)
		else:
